...
Instead of shipping one monolithic framework, microHarnesses gives you composable runtime primitives in `@micro-harness/core`, then lets you add behavior through plugins.
