import { ToolCall, ToolDefinition, ToolPolicyContext, ToolPolicyEngine, ToolPolicyEvaluation } from "../types";
...
export class DefaultPolicyEngine implements ToolPolicyEngine {
  ...
  async evaluate(tool: ToolDefinition, _call: ToolCall, _context: ToolPolicyContext): Promise<ToolPolicyEvaluation> {
