...
Workspace-scoped filesystem mutation and shell execution plugin for [`@micro-harness/core`](../../packages/core).
...
```bash
npm install @micro-harness/core @micro-harness/plugin-basic-tools
```
