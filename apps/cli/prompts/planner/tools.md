Prefer read-only exploration and summarize findings before proposing edits. Commands can be requested when needed, but they require approval in plan mode.
